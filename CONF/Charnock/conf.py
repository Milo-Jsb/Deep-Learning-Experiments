...
def get_args():
    ...
    parser.add_argument("--normalize_target", type=bool, default=True,
    ...
    parser.add_argument("--input_size", type=int,
                        default=14, help="Numero de features")
    parser.add_argument("--num_classes", type=int,
                        default=2, help="Numero de clases")
    ...
    parser.add_argument("--experiment", type=str, default='/exp_chk_4/', 
    ...
    parser.add_argument("--load_model", type=bool,
                        default=True, help="Load pre-trained model") 
    parser.add_argument("--model_path", type=str, default='/best_result/charnockpt-002-0.9152.pt', 
    ...
    parser.add_argument("--source", type=str, default='spcc',
                         choices=['snana', 'spcc'],
